...
def run_vbcr(start_keyspace, end_keyspace, share_number, prefix):
    output_filename = f'{prefix}_share{share_number}.txt'  
...
for share_number in range(1, num_shares + 1):
    ...
    run_vbcr(current_keyspace, next_keyspace, share_number, prefix) 
